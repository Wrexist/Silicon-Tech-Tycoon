...
| **Project ships UNIVERSAL (iPad enabled)** | A | `TARGETED_DEVICE_FAMILY = "1,2"` at `project.pbxproj:341,363`, iPad orientations at `Info.plist:53-59` — while `SHIP_READINESS.md:37`, `BUILD_IOS.md:67-73` and `app-store-screenshots/README.md:50` all assert **iPhone-only**. `ROADMAP.md:219` confirms iPad was enabled deliberately | **VERIFIED (docs contradict the project)** |
