...
- **Determinism is sacred.** The engine (`src/engine/*`) is pure; the pinned 160-week reproducibility
  ...
  11, 23, 37, 53, 71, 83, 91, 97, 101, 113, 127, 131, 137, 149, 151, 157, 163, 211, 223, 227, 229.
  (91/101/113/127 = inbound licensing offers; 163 = contract negotiation outcome; 229 = side-order duration,
