...
import type { ComponentKind, FactoryId, Product, RecruitTier, RegionId, StaffRole } from "../engine/types.ts";
import {
  advanceEraAction,
  advanceOneWeek,
  assignStaff,
