...
describe("each predicate fires only when its real condition is met", () => {
  const cases: { id: string; facts: Partial<AchievementFacts> }[] = [
    ...
    { id: "all-rivals", facts: { rivalsInvested: 12, totalRivals: 12 } },
    ...
    { id: "os-reach-100k", facts: { osInstalledBase: 100_000 } },
    { id: "os-reach-1m", facts: { osInstalledBase: 1_000_000 } },
    { id: "os-kingmaker", facts: { osLicenseeCount: 3 } },
